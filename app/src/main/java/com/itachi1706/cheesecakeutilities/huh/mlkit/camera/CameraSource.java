 ...
 * {@link com.google.android.gms.vision.CameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
 ...
 * </ul>
 */
@SuppressWarnings({"deprecation", "unused", "MissingPermission"})
public class CameraSource {
    ...
    private static final String TAG = "MLKit:CameraSource";
    ...
    public CameraSource(Activity activity, GraphicOverlay overlay, boolean useFlash) {
        this.activity = activity;
        graphicOverlay = overlay;
        graphicOverlay.clear();
        this.flashMode = useFlash;
    ...
    private Camera createCamera() throws IOException {
        ...
        if (flashMode && parameters.getSupportedFlashModes().contains(Camera.Parameters.FLASH_MODE_TORCH))
