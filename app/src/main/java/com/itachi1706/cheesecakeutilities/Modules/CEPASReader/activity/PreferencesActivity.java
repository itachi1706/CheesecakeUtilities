...
public class PreferencesActivity extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        setTheme(SGCardReaderApplication.chooseTheme());
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.pref_cepas_deprecated);
        ...
        mPreferenceTheme = (ListPreference) getPreferenceManager().findPreference(SGCardReaderApplication.PREF_THEME);
        mPreferenceTheme.setOnPreferenceChangeListener(this);

        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            for (String prefKey : new String[]{
                    SGCardReaderApplication.PREF_LOCALISE_PLACES,
                    SGCardReaderApplication.PREF_LOCALISE_PLACES_HELP}) {
