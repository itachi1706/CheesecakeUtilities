 ...
 */
@Deprecated("Migrated")
data class FanficStories(var id: Int, var page_id: Int, var author_id: Int, var title: String?, var chapters: String?) // As of Fanfiction Reader app last updated 13 November 2014
