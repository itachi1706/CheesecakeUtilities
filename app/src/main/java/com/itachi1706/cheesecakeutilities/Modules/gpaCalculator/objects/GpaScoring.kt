 ...
 */
data class GpaScoring(val name: String = "Some name", val description: String = "No description available", val passtier: List<GpaTier>? = null, val gradetier: List<GpaTier> = ArrayList()) {
